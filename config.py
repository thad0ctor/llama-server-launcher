"""
Configuration management utilities for LLaMa.cpp Server Launcher.
...
class ConfigManager:
    """Manages configuration operations for the LLaMa.cpp Server Launcher."""
    
    def __init__(self, launcher_instance):
        """Initialize the ConfigManager with a reference to the main launcher instance."""
    ...
    def load_configuration(self):
        ...
        self.launcher.model_listbox.selection_clear(0, tk.END) # Clear previous visual selection
        ...
        if loaded_model_path_str:
            try:
                ...
                listbox_items = self.launcher.model_listbox.get(0, tk.END)
    ...
    def update_config_listbox(self):
        ...
        self.launcher.config_listbox.delete(0, tk.END)
        sorted_names = sorted(self.launcher.saved_configs.keys())
        for cfg_name in sorted_names:
            self.launcher.config_listbox.insert(tk.END, cfg_name)
